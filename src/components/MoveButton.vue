...
export default {
    ...
    setup(props) {
        // disabled move info request to format moves by level-up, tutor etc
        ...
        const moveInfo = {
            ...
            machines: [
                {
                    machine: { url: "https://pokeapi.co/api/v2/machine/22/" },
                    version_group: {
                        name: "red-blue",
                ...
                {
                    machine: { url: "https://pokeapi.co/api/v2/machine/23/" },
                    version_group: {
                        name: "yellow",
